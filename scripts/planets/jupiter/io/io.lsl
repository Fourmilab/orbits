    ...
    */
    ...
    list planet = [
        ...
        1.26686534e17,      /* 26 Standard gravitational parameter (G M)
...
//tawk("K - GaussK " + (string) (9.7249547e8 - GaussK) + " GaussK " + (string) GaussK);
...
//                    npRot /= llGetRootRotation();   // Must back out rotation of
...
float s_satscale = 1.25e-5 * m_scalePlanet; // Scale factor, satellite orbit km to model metres

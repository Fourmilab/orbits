    ...
    */
    ...
    list planet = [
        ...
        5.793939e15,        /* 26 Standard gravitational parameter (G M)
                                  of primary, m^3/sec^2  */
        <0.3216, 0.5608, 0.3961>,   // 27 Colour of trail tracing orbit
...
/*
    rotation sr(string b) {
        return(< siuf(llGetSubString(b, 0, 5)),
                 siuf(llGetSubString(b, 6, 11)),
                 siuf(llGetSubString(b, 12, 17)),
                 siuf(llGetSubString(b, 18, -1)) >);
    }
*/
